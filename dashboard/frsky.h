...
public:
  ...
  void setDataHandler(DataHandler h) {
    dataHandler = h;
  }
  void setAlarmThresholdHandler(AlarmThresholdHandler h) {
    alarmThresholdHandler = h;
  }
  void setUserDataHandler(UserDataHandler h) {
    userDataHandler = h;
  }
